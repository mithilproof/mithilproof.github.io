...
import { runWithAsyncContext, getCurrentHub, startTransaction, getActiveTransaction, captureException } from '@sentry/core';
...
,
  ...
  return async function ( ...args) {
    return runWithAsyncContext(async () => {
      ...
      const previousSpan = _nullishCoalesce(getTransactionFromRequest(req), () => ( scope.getSpan()));
      let dataFetcherSpan;
      ...
      try {
        ...
        _optionalChain([previousSpan, 'optionalAccess', _ => _.setStatus, 'call', _2 => _2('internal_error')]);
        throw e;
      } finally {
