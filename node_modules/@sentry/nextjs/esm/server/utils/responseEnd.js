...
async function flushQueue() {
  try {
    (typeof __SENTRY_DEBUG__ === 'undefined' || __SENTRY_DEBUG__) && logger.log('Flushing events...');
    await flush(2000);
    (typeof __SENTRY_DEBUG__ === 'undefined' || __SENTRY_DEBUG__) && logger.log('Done flushing events');
  } catch (e) {
    (typeof __SENTRY_DEBUG__ === 'undefined' || __SENTRY_DEBUG__) && logger.log('Error while flushing events:\n', e);
  }
}

export { autoEndTransactionOnResponseEnd, finishTransaction, flushQueue };
