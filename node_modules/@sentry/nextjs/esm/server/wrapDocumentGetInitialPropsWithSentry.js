...
function wrapDocumentGetInitialPropsWithSentry(
  ...
  return new Proxy(origDocumentGetInitialProps, {
    apply: async (wrappingTarget, thisArg, args) => {
      ...
      if (hasTracingEnabled() && req && res && _optionalChain([options, 'optionalAccess', _6 => _6.instrumenter]) === 'sentry') {
...
export { withSentryServerSideDocumentGetInitialProps, wrapDocumentGetInitialPropsWithSentry };
