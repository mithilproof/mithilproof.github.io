import { addTracingExtensions, runWithAsyncContext, getCurrentHub, startTransaction, captureException } from '@sentry/core';
import { extractTraceparentData, baggageHeaderToDynamicSamplingContext } from '@sentry/utils';
import { isNotFoundNavigationError, isRedirectNavigationError } from '../common/nextNavigationErrorUtils.js';
    ...
    apply: (originalFunction, thisArg, args) => {
      return runWithAsyncContext(() => {
        ...
        const handleErrorCase = (e) => {
          ...
          } else if (isRedirectNavigationError(e)) ; else {
